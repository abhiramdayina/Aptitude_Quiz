...
import static com.example.aptitudeoffline.practice.listclocks;

public class practiceclocks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceclocks);
        ...
        allQuestionsList=listclocks;
        Collections.shuffle(allQuestionsList);
        modelclass=listclocks.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceclocks.this,complete.class);
