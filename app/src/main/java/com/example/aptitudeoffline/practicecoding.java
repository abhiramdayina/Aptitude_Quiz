...
import static com.example.aptitudeoffline.practice.listcoding;

public class practicecoding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicecoding);
        ...
        allQuestionsList=listcoding;
        Collections.shuffle(allQuestionsList);
        modelclass=listcoding.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practicecoding.this,complete.class);
