...
import static com.example.aptitudeoffline.practice.listdirections;

public class practicedirections extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicedirections);
        setupUIViews();
        ...
        allQuestionsList=listdirections;
        Collections.shuffle(allQuestionsList);
        modelclass=listdirections.get(index);
    ...
    public void Wrong(CardView cardView){
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (index<listdirections.size()-1){
                    index++;
                    modelclass=listdirections.get(index);
                    resetColor();
                    setAllData();
    ...
    private void GameWon(){
        Intent intent = new Intent(practicedirections.this,complete.class);
