...
import static com.example.aptitudeoffline.practice.listblood;

public class practiceblood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceblood);
        ...
        allQuestionsList=listblood;
        Collections.shuffle(allQuestionsList);
        modelclass=listblood.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceblood.this,complete.class);
