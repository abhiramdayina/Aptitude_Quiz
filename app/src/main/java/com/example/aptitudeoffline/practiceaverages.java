...
import static com.example.aptitudeoffline.practice.listavg;

public class practiceaverages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceaverages);
        ...
        allQuestionsList=listavg;
        Collections.shuffle(allQuestionsList);
        modelclass=listavg.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceaverages.this,complete.class);
