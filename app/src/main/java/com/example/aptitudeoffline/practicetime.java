...
import static com.example.aptitudeoffline.practice.listtime;

public class practicetime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicetime);
        setupUIViews();
        ...
        allQuestionsList=listtime;
        Collections.shuffle(allQuestionsList);
        modelclass=listtime.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practicetime.this,complete.class);
