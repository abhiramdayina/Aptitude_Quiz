...
import static com.example.aptitudeoffline.practice.listprofit;

public class practiceprofit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceprofit);
        setupUIViews();
        ...
        allQuestionsList=listprofit;
        Collections.shuffle(allQuestionsList);
        modelclass=listprofit.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceprofit.this,complete.class);
