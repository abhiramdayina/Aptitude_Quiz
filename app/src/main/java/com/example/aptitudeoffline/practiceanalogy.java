...
import static com.example.aptitudeoffline.practice.listanalogy;

public class practiceanalogy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceanalogy);
        ...
        allQuestionsList=listanalogy;
        Collections.shuffle(allQuestionsList);
        modelclass=listanalogy.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceanalogy.this,complete.class);
