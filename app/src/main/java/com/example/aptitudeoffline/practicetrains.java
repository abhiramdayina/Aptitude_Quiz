...
import static com.example.aptitudeoffline.practice.listtrains;

public class practicetrains extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicetrains);
        ...
        allQuestionsList=listtrains;
        Collections.shuffle(allQuestionsList);
        modelclass=listtrains.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practicetrains.this,complete.class);
