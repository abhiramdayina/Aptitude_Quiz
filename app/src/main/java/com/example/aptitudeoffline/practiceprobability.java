...
import static com.example.aptitudeoffline.practice.listprobability;

public class practiceprobability extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceprobability);
        ...
        allQuestionsList=listprobability;
        Collections.shuffle(allQuestionsList);
        modelclass=listprobability.get(index);
    ...
    public void Wrong(CardView cardView){
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (index<listprobability.size()-1){
                    index++;
                    modelclass=listprobability.get(index);
                    resetColor();
                    setAllData();
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceprobability.this,complete.class);
