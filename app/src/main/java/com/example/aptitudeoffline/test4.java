...
import static com.example.aptitudeoffline.test.testfour;
...
public class test4 extends AppCompatActivity {
    ...
    public static int correctCount4=0;
    public static int wrongCount4=0;
    public static int unanswered4=0;
    ImageButton nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTimer();
        allQuestionsList=testfour;
        Collections.shuffle(allQuestionsList);
        modelclass=testfour.get(index);
        setAllData();
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(TimeLeftInMillis,1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(test4.this,result4.class);
