...
import static com.example.aptitudeoffline.practice.listpercent;

public class practicepercentages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicepercentages);
        ...
        allQuestionsList=listpercent;
        Collections.shuffle(allQuestionsList);
        modelclass=listpercent.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practicepercentages.this,complete.class);
