...
import static com.example.aptitudeoffline.test.testtwo;
...
public class test2 extends AppCompatActivity {
    ...
    public static int unanswered2=0;
    ImageButton nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTimer();
        allQuestionsList=testtwo;
        Collections.shuffle(allQuestionsList);
        modelclass=testtwo.get(index);
        setAllData();
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(TimeLeftInMillis,1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(test2.this,result2.class);
    ...
    private void GameWon(){
        Intent intent2 = new Intent(test2.this,result2.class);
