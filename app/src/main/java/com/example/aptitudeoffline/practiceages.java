...
import static com.example.aptitudeoffline.practice.listages;

public class practiceages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceages);
        ...
        allQuestionsList=listages;
        Collections.shuffle(allQuestionsList);
        modelclass=listages.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceages.this,complete.class);
