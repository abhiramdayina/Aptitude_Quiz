...
import static com.example.aptitudeoffline.practice.listdecimals;

public class practicedecimals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicedecimals);
        ...
        allQuestionsList=listdecimals;
        Collections.shuffle(allQuestionsList);
        modelclass=listdecimals.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practicedecimals.this,complete.class);
