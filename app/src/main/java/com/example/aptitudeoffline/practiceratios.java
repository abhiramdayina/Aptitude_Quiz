...
import static com.example.aptitudeoffline.practice.listratios;

public class practiceratios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceratios);
        ...
        allQuestionsList=listratios;
        Collections.shuffle(allQuestionsList);
        modelclass=listratios.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceratios.this,complete.class);
