...
import static com.example.aptitudeoffline.practice.listroots;

public class practiceroots extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practiceroots);
        ...
        allQuestionsList=listroots;
        Collections.shuffle(allQuestionsList);
        modelclass=listroots.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practiceroots.this,complete.class);
