...
import static com.example.aptitudeoffline.practice.listcalendar;

public class practicecalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practicecalendar);
        ...
        allQuestionsList=listcalendar;
        Collections.shuffle(allQuestionsList);
        modelclass=listcalendar.get(index);
    ...
    private void GameWon(){
        Intent intent = new Intent(practicecalendar.this,complete.class);
