...
import static com.example.aptitudeoffline.test.testthree;
...
public class test3 extends AppCompatActivity {
    ...
    public static int correctCount3=0;
    public static int wrongCount3=0;
    public static int unanswered3=0;
    ImageButton nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTimer();
        allQuestionsList=testthree;
        Collections.shuffle(allQuestionsList);
        modelclass=testthree.get(index);
        setAllData();
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(TimeLeftInMillis,1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(test3.this,result3.class);
