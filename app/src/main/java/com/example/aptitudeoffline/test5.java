...
import static com.example.aptitudeoffline.test.testfive;
...
public class test5 extends AppCompatActivity {
    ...
    public static int correctCount5=0;
    public static int wrongCount5=0;
    public static int unanswered5=0;
    ImageButton nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTimer();
        allQuestionsList=testfive;
        Collections.shuffle(allQuestionsList);
        modelclass=testfive.get(index);
        setAllData();
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(TimeLeftInMillis,1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(test5.this,result5.class);
